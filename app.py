            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  Southampton Expo 2026</br>
                  29th Jan 2026 | Southampton Expo<br/>
                  <br/>
                  On Behalf of<br/>
                  Richard<br/>
                  Show Director<br/>
                  <a href="mailto:richard@southamptonbusinessexpo.co.uk"
                     style="color:#D7262F">richard@southamptonbusinessexpo.co.uk</a><br/>
                </p>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.southamptonbusinessexpo.co.uk", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="richard@southamptonbusinessexpo.co.uk")
